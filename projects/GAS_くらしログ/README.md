<h1>📊 くらしログ - 家庭用管理ツール</h1>

<div align="center">

<p><strong>GAS × スプレッドシートで作る、丁寧に続けられる家計管理</strong></p>

<p><strong>30〜40代女性向けの在庫管理・家計簿・コスパ分析システム</strong></p>
...
| 課題 | 解決策 |
|------|--------|
| 🛒 **買いすぎ・ダブり買いを防ぐ** | 在庫管理機能で現在庫を可視化 |
| 💰 **家計の流れを「見える化」する** | カレンダー・グラフで支出を視覚化 |
| 📊 **感覚ではなくデータでコスパを判断** | 過去の購入履歴から最安値・平均単価を分析 |

</div>

### ソリューション

Google Apps Script（GAS）とGoogleスプレッドシートを用いて、**コスト0円**で始められる家庭用管理システムを構築。
...
私自身、プログラミングを学ぶ前から、手書きでコスパノートや家計簿をつけていました。しかし、「これがデータとして活用できたら、もっと良いのに...」と感じながらも、当時はExcelやスプレッドシートすら苦手で、実現できずにいました。
...
| 機能 | テーマカラー | 狙い |
|------|------------|------|
| 💚 **在庫管理機能** | エメラルドグリーン | 爽やかで落ち着いた、毎日見ても飽きない色 |
| 💙 **コスパ・履歴機能** | ロイヤルブルー | 知的で信頼感のある、分析にふさわしい色 |
| 💗 **家計簿機能** | ビビッドピンク | 華やかで気分が上がる、楽しい色 |
